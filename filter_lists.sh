...
wget https://raw.githubusercontent.com/SirKubiac/Block-Lists/refs/heads/main/ATR_White_List.txt -P /var/filter_lists/ -O /var/filter_lists/File_3.txt
wget https://cdn.jsdelivr.net/gh/hagezi/dns-blocklists@latest/wildcard/doh-onlydomains.txt -P /var/filter_lists/ -O /var/filter_lists/DoH.txt
...
sed -i '/^#/d' /var/filter_lists/DoH.txt
sed -i '/^\s*$/d' /var/filter_lists/DoH.txt

# Entfernen der Einträge aus File_2.txt und File_3.txt
grep -v -F -f /var/filter_lists/File_2.txt /var/filter_lists/File_1.txt | grep -v -F -f /var/filter_lists/File_3.txt > /var/filter_lists/Merged.txt
...
rm /var/filter_lists/File_1.txt /var/filter_lists/File_2.txt /var/filter_lists/File_3.txt
